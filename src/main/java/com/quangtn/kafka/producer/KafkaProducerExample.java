package com.quangtn.kafka.producer;
...
public class KafkaProducerExample {
    ...
    private static Producer<String, String> createProducer() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, Commons.EXAMPLE_KAFKA_SEVER);
    ...
    private static void createTopic() {
        ...
        ZkClient zkClient = new ZkClient(Commons.EXAMPLE_ZOOKEEPER_SERVER, sessionTimeoutMs,
        ...
        if (!AdminUtils.topicExists(zkUtils, Commons.EXAMPLE_KAFKA_TOPIC)) {
            AdminUtils.createTopic(zkUtils, Commons.EXAMPLE_KAFKA_TOPIC, partition,
