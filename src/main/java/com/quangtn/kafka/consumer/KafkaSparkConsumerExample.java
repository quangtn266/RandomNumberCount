package com.quangtn.kafka.consumer;
...
public class KafkaSparkConsumerExample {
    ...
    public static void main(final String... args) {
        ...
        kafkaParams.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, Commons.EXAMPLE_KAFKA_SEVER);
        kafkaParams.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        kafkaParams.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        kafkaParams.put(ConsumerConfig.GROUP_ID_CONFIG, "SparkConsumerGroup");

        // Configure Spark to listen message in topic test
        ...
        // Start reading messages from Kafka and get Datastream
        ...
        // Take every words word and return Tuple with (word, 1)
